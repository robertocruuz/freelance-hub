  ...
  return (
    <div className="relative z-10 h-full flex flex-col overflow-hidden">
      ...
      {view === 'kanban' && (
        ...
        >
          <div className="flex gap-3 md:gap-4 overflow-x-auto overflow-y-auto pb-4 flex-1 min-h-0 scrollbar-thin scroll-smooth snap-x snap-mandatory md:snap-none items-start">
