  ...
  const cards = [
    {
      ...
      borderColor: balance >= 0 ? 'border-border' : 'border-border',
    },
    {
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-6">
      {cards.map((c) => (
        <div
          key={c.label}
          className={`relative overflow-hidden rounded-2xl border ${c.borderColor} bg-card p-5 sm:p-6 transition-all`}
        >
          {/* Decorative circle */}
