...
export default function LeadCard({ lead, onEdit, onDelete, onWin, onLose, onConvertToProject }: LeadCardProps) {
  ...
  return (
    <div
      onClick={() => onEdit(lead)}
      className="bg-card border border-border/50 shadow-sm rounded-[8px] p-4 cursor-pointer hover:shadow-md hover:border-border transition-all duration-200 group relative"
    >
